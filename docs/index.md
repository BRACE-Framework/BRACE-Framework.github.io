...
Currently, when discussing circumvention, the digital rights community has focused on promoting certain tools that claim to serve specific purposes at a given time. For example, mesh networks for local communication or VPNs for bypassing throttling or social media shutdowns.

However, the perspectives of cost, needs, and risk specific to each community have yet to be fully considered. The approach to circumventing internet shutdowns should focus on integrating risk, cost, needs, and capability to enhance the feasibility of mitigation plans.
...
![Priority matrix](https://i.ibb.co/mVYvtVBD/Screenshot-2025-03-18-at-16-25-46.png)
